                    ...
                    <tr class="<?= $proximo ? 'bg-blue-50 dark:bg-blue-900' : '' ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                <a href="../avaliacoes/registrar.php?cliente_id=<?php echo $agendamento['id']; ?>"
        ...
        <div
            ...
            <div class="bg-gray-50 px-5 py-3">
                <div class="flex justify-between space-x-2">
                    ...
                    <?php if ($agendamento['status'] === 'confirmado' || $agendamento['status'] === 'realizado'): ?>
                    <a href="registrar.php?id=<?= $agendamento['id'] ?>"
                        class="text-purple-600 hover:text-purple-900 p-1 rounded-md hover:bg-purple-50 transition-colors duration-200"
                        title="Fazer Avaliação">
                        <i class="fas fa-star"></i>
                    </a>
                    <?php endif; ?>
